...
<!-- 		<div class="panel panel-primary">
		...
		<div id="content" class="col-sm-8">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h4 class="panel-title"><i class="glyphicon glyphicon-header"></i> 客 户 列 表</h4>
				</div>
						...
						<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
								...
								<td>
									<div class="btn-group btn-group-xs">
										<a href="<?php echo U('Admin/Member/memberUpdate',array('uid'=>$vo['uid']));?>" class="btn btn-warning"><i class="glyphicon glyphicon-edit"></i></a>
										<?php if($vo["uid"] == 100001): else: ?>
										<a href="<?php echo U('Admin/Member/deleteHandle',array('uid'=>$vo['uid']));?>" class="btn btn-danger"><i class="glyphicon glyphicon-remove"></i></a><?php endif; ?>
									</div>
									</td>
