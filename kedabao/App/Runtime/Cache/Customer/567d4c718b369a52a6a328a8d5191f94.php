...
<!--    <div class="form-group">
    ...
    <div class="col-sm-10">
      <select name="company" id='wxcats'>
	  <option value="<?php echo ($list["wx_cats"]); ?>"><?php echo ($list["wx_cats"]); ?></option>
	  </select>
    </div>
  </div>
  <div class="form-group">
    ...
    <div class="col-sm-10">
		<select id='cats' name="did" placeholder="" >
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
		<select id='products' name="pid" placeholder="">
		<option value="<?php echo ($list["did"]); ?>"><?php echo ($list["dname"]); ?></option>
		</select>
    </div>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
   ...
   <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
	  ...
	  <a href="<?php echo U(GROUP_NAME.'/Product/index');?>" class="btn btn-default" >返回</a>
    </div>
  </div>
</form>
