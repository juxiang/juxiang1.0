	...
	<div class="panel-group" id="accordion">
		...
		<div id="content" class="col-sm-8">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h4 class="panel-title"><i class="glyphicon glyphicon-header"></i> 分类列表</h4>
				</div>
...
<?php if(is_array($cats)): $i = 0; $__LIST__ = $cats;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><form class="form-horizontal" action='__APP__/Cats/update/cid/<?php echo ($vo["id"]); ?>' method='post' enctype='multipart/form-data'>
	<tr>
		<td >
		<select name='wx_cats'>
		<option value="<?php echo ($vo["wx_cats"]); ?>"><?php echo ($vo["wx_cats"]); ?></option>
		</select>
		</td>
		<td ><input type='text' name='cats' value='<?php echo ($vo["cname"]); ?>'></td>
		<td >
		<div class="btn-group btn-group-xs">
			<input value='修改' type='submit' class="btn btn-warning"><a href="__APP__/Cats/delete/cid/<?php echo ($vo["id"]); ?>" class="btn btn-danger"><i class="glyphicon glyphicon-remove"></i></a>
		</div>
	</tr>
