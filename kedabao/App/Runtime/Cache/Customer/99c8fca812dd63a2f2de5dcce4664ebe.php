...
<body>
	...
	<div id="content" class="col-sm-8">
		<div class="panel panel-default">
				<div class="panel-heading">
					<h4 class="panel-title"><i class="glyphicon glyphicon-header"></i>前端显示</h4>
				</div>
			<div class="panel-body">
		<?php if(is_array($wx_cats)): $i = 0; $__LIST__ = $wx_cats;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$wx_cats): $mod = ($i % 2 );++$i;?>点击进行预览：<a  class='btn btn-primary' href="<?php echo U(GROUP_NAME.'/Wxdisplay/index',array('wxcats'=>$wx_cats[0],'uid'=>session('uid')));?>" target='_blank'><?php echo ($wx_cats["0"]); ?></a><br /><br /><?php endforeach; endif; else: echo "" ;endif; ?>
	<strong>请将预览的链接，固定到微信二级菜单的url</strong>
	<hr/>
