	...
	<div class="panel-group" id="accordion">
		...
		<div id="content" class="col-sm-8">
			<div class="panel panel-default">
				...
				<div class="panel-body">
<form class="form-horizontal" action="<?php echo U(GROUP_NAME.'/Dishes/doadd');?>" method='post' enctype='multipart/form-data'>
  ...
  <div class="form-group">
   ...
   <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
	  ...
	  <a href="<?php echo U(GROUP_NAME.'/Dishes/index');?>" class="btn btn-default" >返回</a>
    </div>
  </div>
</form>
</div>
